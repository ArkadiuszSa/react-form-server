...
router.post("/happening", [
    check_1.check("title", "title is required")
        .not()
        .isEmpty(),
    check_1.check("description", "description is required")
        .not()
        .isEmpty(),
    check_1.check("days", "days is required")
        .not()
        .isEmpty(),
    check_1.check("price", "price is required")
        .not()
        .isEmpty()
], (req, res, next) => {
