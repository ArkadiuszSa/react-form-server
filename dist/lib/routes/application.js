...
router.post('/application', [
    ...
    check_1.check('happeningId', 'happeningId is required').not().isEmpty(),
    check_1.check('firstName', 'firstName is required').not().isEmpty(),
    check_1.check('lastName', 'lastName is required').not().isEmpty(),
    check_1.check('email', 'email is required').not().isEmpty(),
    check_1.check('date', 'date is required').not().isEmpty(),
